 ...
 * @version 1.0
 * @since 13/04/2021 at 19:33
 */

@ExtendWith(MockitoExtension.class)
class VisitControllerTest {

    private final String PETS_CREATE_OR_UPDATE_VISIT_FORM = "pets/createOrUpdateVisitForm";
    private final String REDIRECT_OWNERS_1 = "redirect:/owners/{ownerId}";
    private final String YET_ANOTHER_VISIT_DESCRIPTION = "yet another visit";
