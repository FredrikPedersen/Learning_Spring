...
class OwnerControllerTest {
    ...
    void processFindFormReturnMany() throws Exception {
        when(ownerService.findAllByLastNameLike(anyString())).thenReturn(asList(
    ...
    void processFindFormReturnOne() throws Exception {
        when(ownerService.findAllByLastNameLike(anyString())).thenReturn(singletonList(Owner.builder().id(1L).build()));
